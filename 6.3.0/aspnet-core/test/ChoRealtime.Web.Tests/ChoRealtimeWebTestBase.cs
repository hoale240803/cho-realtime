...
{
    public abstract class ChoRealtimeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ChoRealtimeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ChoRealtimeWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ChoRealtimeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ChoRealtimeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ChoRealtimeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ChoRealtimeDbContext, Task<T>> func)
        {
            T result;
